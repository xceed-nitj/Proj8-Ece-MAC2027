...
function Slider() {
  ...
  return (
    <motion.div 
      className="relative h-full w-full overflow-hidden rounded-lg sm:rounded-xl bg-blue-50"
...
function AboutDept(props) {
  ...
  return (
    <motion.section 
      className="relative py-10 sm:py-14 md:py-20 w-full bg-gradient-to-b from-white via-blue-50/10 to-white overflow-hidden"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Floating elements */}
        <div className="absolute -top-10 right-20 w-20 sm:w-30 md:w-40 h-20 sm:h-30 md:h-40 bg-blue-200/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 -left-10 w-30 sm:w-40 md:w-60 h-30 sm:h-40 md:h-60 bg-blue-100/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          <h2 className="inline-block text-xl sm:text-2xl md:text-3xl font-poppins text-blue-900 mb-2 sm:mb-3 relative">
        ...
        {/* Main Content Card */}
        <motion.div 
          className="max-w-7xl mx-auto bg-white rounded-lg sm:rounded-xl shadow-md sm:shadow-xl border border-blue-50 overflow-hidden"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="lg:col-span-3 p-4 sm:p-6 md:p-8">
              ...
              <div className="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-blue-100">
                <h3 className="text-base sm:text-lg font-medium text-blue-900 mb-3 sm:mb-4">Department Highlights</h3>
              ...
              <div className="mt-6 sm:mt-8">
                <a 
                  ...
                  className="inline-flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-300 text-xs sm:text-sm"
                >
